function [ Ycap ] = lraNCP( Y,opts )
%% Fast Non-Negative CP Decomposition based on Low-rank Approximation
...
%   opts.alpha,beta  The step is set to
%                         1-alpha*exp(-beta*it) 
%                    alpha=1 is default. beta should be very small, typical
%                    beta=0.005.
%                    
% The paper is preparing. Currently please cite
...
%% This file is empty and provides help information for lraNCP.p
% Ycap=lraNCP(Y,opts);