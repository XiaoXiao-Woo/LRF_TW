...
global TDALAB_BackGroundColor
global TDALAB_ColorMap
global MaxI
...
[NumberOfColors, p_col] = size(TDALAB_ColorMap);
...
%         end
    ...
    elseif strcmp( action, 'slider_show_channels' ) == 1,
        ...
        for i=1:RealNoOfSubplots,
            ...
            set( axes_line, 'Color', TDALAB_ColorMap(idx_col,:) );
        ...
        TDALAB_selectchn( [], [], 'plot_rectangle' );
    ...
    elseif strcmp( action, 'check_signal' ) == 1,
        ...
        TDALAB_selectchn( [], [], 'check_plot_all_signals' );
    ...
    h1 = uicontrol( 'Parent', h0, ...
        'Units','normalized',...
        'BackgroundColor', TDALAB_BackGroundColor, ...
        'Callback', 'TDALAB_selectchn( [], [], ''check_plot_all_signals'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'ListboxTop',0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''edit_set_start_pos'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor', [1 1 1], ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''edit_set_stop_pos'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor', TDALAB_BackGroundColor, ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''radio_set_scale'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor',[1 1 1], ...
        'ListboxTop',0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''edit_set_min_scale'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor', [1 1 1], ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''edit_set_max_scale'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'String', 'Select all', ...
        'Callback', 'TDALAB_selectchn( [], [], ''select_all_channels'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor', TDALAB_BackGroundColor, ...
        'ListboxTop',0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''unselect_all_channels'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor', [1 1 1], ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''set_start_display_range'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor',[1 1 1], ...
        'ListboxTop',0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''set_stop_display_range'' );', ...
    ...
    if T <= MaxI
        h1 = uicontrol( 'Parent', h0, ...
            'Units', 'Normalized', ...
            'BackgroundColor', TDALAB_BackGroundColor, ...
            'Callback', 'TDALAB_selectchn( [], [], ''horizontal_slider'' );', ...
            'ListboxTop',0, ...
    ...
    if n > NoOfSubplots, 
        ...
        mslider = uicontrol( 'Parent', h0, ...
            ...
            'BackgroundColor', TDALAB_BackGroundColor, ...
            'ListboxTop', 0, ...
            'Callback', 'TDALAB_selectchn( [], [], ''slider_show_channels'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'BackgroundColor' ,TDALAB_BackGroundColor, ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''button_ok'' );', ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        'Units', 'characters', ...
        'BackgroundColor', TDALAB_BackGroundColor, ...
        'Callback', 'TDALAB_selectchn( [], [], ''button_cancel'' );', ...
        'ListboxTop', 0, ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        'Units', 'characters', ...
        'BackgroundColor', TDALAB_BackGroundColor, ...
        'Callback', 'TDALAB_selectchn( [], [], ''button_save'' );', ...
        'ListboxTop', 0, ...
    ...
    h1 = uicontrol( 'Parent', h0, ...
        ...
        'ListboxTop', 0, ...
        'Callback', 'TDALAB_selectchn( [], [], ''button_help'' );', ...
    ...
    for i=start:start+RealNoOfSubplots-1,
        ...
        h2 = line( 'Parent', h1, ...
            ...
            'Color', TDALAB_ColorMap(idx+start-1,:), ...
            'XData', 1:T, ...
            'YData', s(i,:) );
        ...
        h3 = uicontrol( 'Parent', h0, ...
            ...
            'HorizontalAlignment', 'left', ...
            'ListboxTop', 0, ...
            'Callback', 'TDALAB_selectchn( [], [], ''check_signal'' );', ...
            'BackgroundColor', TDALAB_BackGroundColor, ...
