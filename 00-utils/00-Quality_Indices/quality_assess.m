function [out] = quality_assess(imagery1, imagery2, img_range)
%==========================================================================
...
for ii = 1:prod(Nway(3:end))
    psnr(ii) = psnr_index(imagery1(:, :, ii), imagery2(:, :, ii), img_range);
    ssim(ii) = ssim_index(imagery1(:, :, ii), imagery2(:, :, ii), img_range);
end
